...
export const DEFAULT_PLAN = [
  ...
  { date: '2026-09-18', title: 'Étape 2 — Chamonix, puis bascule en Suisse vers Aoste', base: '', spots: [], planB: null, drive: { km: 220, min: 250, label: 'Aix-les-Bains → Chamonix → Aoste (Forclaz, Grand-Saint-Bernard)' }, note: '~1h45 depuis Aix-les-Bains jusqu’à Chamonix par Annecy et la vallée de l’Arve. Journée à Chamonix : vue sur le glacier des Bossons et l’Aiguille du Midi, balade avec le chien au Lac des Gaillands (privilégier une balade basse aujourd’hui : coup de froid en cours, un peu de neige relevée en vallée). Pour rejoindre l’Italie sans payer le tunnel du Mont-Blanc (80-130 € en camping-car !), bascule en fin d’après-midi par la Suisse : Col de la Forclaz (gratuit) jusqu’à Martigny, puis Col du Grand-Saint-Bernard (2469 m, gratuit, confirmé ouvert) jusqu’à Aoste — pas de vignette suisse nécessaire en restant hors autoroute. En repli si le col est fermé par la neige : son tunnel juste en dessous, ~48,50 € l’aller en camping-car, bien moins cher que le Mont-Blanc. Nuit : aire camping-car d’Aoste.' },
