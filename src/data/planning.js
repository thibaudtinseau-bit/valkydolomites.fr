...
export const DEFAULT_PLAN = [
  ...
  { date: '2026-09-20', title: 'Étape 4 — Arrivée aux Dolomites (pause rando à mi-chemin)', base: 'fassa', spots: ['lago-di-carezza', 'latemar'], planB: 'lago-di-carezza', drive: { km: 310, min: 230, label: 'Côme → Obereggen, via Rovereto (rando Lago di Cei)' }, note: '~3h50 de route au total (Lecco/Bergame → Brescia → Vérone → Rovereto → A22 → Val d’Ega), coupée en deux par une vraie pause à mi-chemin. Le matin : ~2h15 jusqu’à la sortie Rovereto Sud. Début d’après-midi : boucle facile et ombragée au Lago di Cei (~5 km, 1h30-2h, plat, superbe pour le chien), pique-nique au bord de l’eau. Profitez-en pour faire le plein à Rovereto (Eni Via Cavour, IP Via Benacense) : gasoil ~7-9 centimes/L moins cher qu’à une pompe d’autoroute. Puis reprise de la route (~1h30) jusqu’à Obereggen/Val d’Ega. Arrivée en soirée : tour rapide du Lago di Carezza si l’heure le permet (déjà connu), Latemar reporté à un autre jour. Nuit : Obereggen ou aire de Canazei.' },
