...
// La funivia du Sass Pordoi prévue en J7 est abandonnée : muselière obligatoire en cabine et
// plateau sommital peu confortable pour le chien. Remplacée par le Viel dal Pan (sentier 601),
// qui part du Passo Pordoi à pied et longe la Marmolada — même objectif, sans remontée.
// Rappel pour J8 et J9, qui utilisent encore une benne : chien gratuit mais muselière + laisse
...
export const DEFAULT_PLAN = [
  ...
  { date: '2026-09-23', title: 'J7 — Viel dal Pan : la Marmolada sans téléphérique', base: 'fassa', spots: ['lago-fedaia'], planB: 'lago-fedaia', drive: { km: 55, min: 80, label: 'Moena → Passo Pordoi → (rando) → Passo Fedaia' }, note: '🔄 Révisé le 23/09 au matin, départ de Moena : la funivia du Sass Pordoi est abandonnée (muselière obligatoire en cabine, et le plateau sommital n’est pas un terrain confortable pour le chien). On garde le Pordoi, mais à pied. MATIN — Moena → Canazei → Passo Pordoi : ~30 km, 40-45 min en van (28 lacets sur la montée depuis Canazei, prendre son temps). Grand parking gratuit au col (2 239 m). RANDO — le Viel dal Pan (sentier 601, alias Bindelweg, « le chemin du pain » des anciens marchands) : boucle par le Rifugio Fredarola (2 370 m) puis le Rifugio Viel dal Pan (2 432 m), 9,2 km, +513 m, 3h30-4h. C’est un sentier-balcon large et roulant qui tient l’altitude autour de 2 400 m : aucune remontée, aucun câble, aucun passage exposé, demi-tour possible n’importe où. Et surtout il fait face à la Marmolada et au Lago Fedaia sur toute sa longueur — l’objectif manqué du 21/09 est récupéré, en mieux et sans benne. À 2 400 m fin septembre les troupeaux sont redescendus : risque patous quasi nul, contrairement aux vallées d’alpage. Pas d’ombre et pas d’eau sur la crête : gourde du chien obligatoire, et coupe-vent (ça souffle). AllTrails : https://www.alltrails.com/trail/italy/veneto/passo-pordoi-rifugio-viel-dal-pan-rifugio-fredarola — SOIR : descente sur Arabba puis Passo Fedaia (~35 min), nuit au barrage face au glacier. ALTERNATIVE si on veut rester strictement sous 40 min de route : Val San Nicolò depuis Pozza (12 min de Moena), boucle 11,7 km / +374 m, vallée plate et rivière, paradis du chien — mais troupeaux possibles et on perd la Marmolada.' },
