...
//
// ─── Révision du 23/09 (matin, depuis Moena) ───
// J7 : la funivia du Sass Pordoi est abandonnée (muselière obligatoire en cabine, plateau sommital
// peu confortable pour le chien). Remplacée d'abord par le Viel dal Pan, puis — choix retenu sur
// place — par la Val San Nicolò, à 12 min de Moena : route de vallée fermée aux voitures, tout à
// pied, demi-tour possible partout. La Marmolada est donc à nouveau reportée (vue depuis le Fedaia
// le soir). Rappel pour J8 et J9, qui utilisent une benne : chien gratuit mais muselière + laisse
// obligatoires en cabine et en gare sur tout le Dolomiti Superski.
...
export const DEFAULT_PLAN = [
  ...
  { date: '2026-09-23', title: 'J7 — Val San Nicolò, la vallée du chien', base: 'fassa', spots: ['lago-fedaia'], planB: 'lago-fedaia', drive: { km: 50, min: 55, label: 'Moena → parking Vidor (12 min) → (rando) → Passo Fedaia' }, note: '🔄 Révisé le 23/09 depuis Moena : choix de la Val San Nicolò plutôt que du Viel dal Pan, pour rester à 12 min de route. ⚠️ POINT CLÉ — la route de la vallée est FERMÉE aux voitures depuis 2018. On se gare au parking de Vidor / Meida (Strada de Ruf de Ruacia, après le parking des remontées du Buffaure, ~1 370 m) et tout se fait à pied. ITINÉRAIRE — piste puis route pastorale qui remonte le Rio San Nicolò : Malga Crocifisso (1 526 m) → Sauch (1 735 m) → Baita Ciampiè (1 826 m) → Baita alle Cascate (2 011 m). On fait demi-tour où on veut, c’est une vallée : Sauch ≈ 7 km A/R et +365 m ; Baita Ciampiè ≈ 11 km A/R et +460 m (👈 la cible) ; Baita alle Cascate ≈ 14 km A/R et +640 m si le chien est en forme. RETOUR — ne pas refaire la piste : descendre par le sentier 641, la « Strada dei Russi » construite par des prisonniers russes en 14-18, qui longe le torrent sous les baite (racines, passerelles, ombre). 🐶 Terrain parfait : pas de câble, pas de vide, eau partout, ombre, demi-tour possible en permanence. Seul vrai point de vigilance, c’est une vallée d’alpage : troupeaux et chiens de garde possibles jusqu’en octobre, laisse courte et on contourne large. 🚐 NAVETTE DE SECOURS — elle tourne jusqu’au 10 octobre, 8h30-18h30 toutes les 30 min depuis Vidor jusqu’au Sauch : 7 € par personne + 3 € pour le chien, billets à la guichet de Strada de Meida ou sur navettesenjan.trotta.it. Utile si le chien fatigue, ou pour monter au Sauch et ne faire que la descente. 🗺️ Route Moena → parking : https://www.google.com/maps/dir/?api=1&origin=Moena&destination=Parcheggio+Vidor+Val+San+Nicolo+Pozza+di+Fassa&travelmode=driving — Tracé de la rando : https://www.google.com/maps/dir/?api=1&origin=Parcheggio+Vidor+Val+San+Nicolo&destination=Baita+alle+Cascate+Val+San+Nicolo&waypoints=Malga+Crocifisso+Val+San+Nicolo%7CBaita+Ciampie+Val+San+Nicolo&travelmode=walking — GPX : https://www.outdooractive.com/en/route/hiking-trail/val-di-fassa/val-san-nicolo/1376255/. Pas de réseau dans la vallée : télécharger la carte hors ligne avant de partir. SOIR — Pozza → Canazei → Alba → Passo Fedaia (~40 min), nuit au barrage face au glacier de la Marmolada.' },
  { date: '2026-09-24', title: 'J8 — Seceda, le graal', base: 'val-gardena', spots: ['seceda'], planB: 'vallunga', drive: { km: 45, min: 75, label: 'Fedaia → Passo Sella → Ortisei → Pontives' }, note: 'LE jour à caler sur la meilleure météo de la fenêtre — à échanger sans hésiter avec J9 si le ciel est meilleur vendredi. Départ tôt du Fedaia, remontée par Canazei et le Passo Sella jusqu’à Ortisei (~1h15). Cabinovia Ortisei-Furnes puis funivia Furnes-Seceda (en service jusqu’au 2 novembre, aucun risque de fermeture). Crêtes de Seceda face aux Odle, puis descente par Cisles et Col Raiser. Nuit : Camperpark Pontives (zone artisanale Pontives, entre Ortisei et Laion) — et bonne nouvelle pour la muscu, le Move Fitnesscenter est sur la même zone (Pontives 15, TECA / Technogym / Matrix / Life Fitness, 6h-23h, ☎ +39 351 661 5789, demander le tarif journalier). ⚠️ Chien en cabine : sur les remontées du Dolomiti Superski il voyage gratuitement, mais la MUSELIÈRE est obligatoire en cabine et en gare (laisse aussi). Si c’est rédhibitoire, la Vallunga depuis Selva se fait intégralement à pied et devient le programme du jour. Plan B météo : Vallunga, vallée plate, paradis du chien.' },
  { date: '2026-09-25', title: 'J9 — L’Alpe di Siusi et la nuit confort', base: 'siusi', spots: ['alpe-di-siusi', 'sciliar'], planB: 'alpe-di-siusi', drive: { km: 30, min: 45, label: 'Pontives → Siusi (cabinovia) → Völs' }, note: '⚠️ Piège 2026 : la route Siusi → Compatsch est interdite 9h-17h, et les parkings P1 Spitzbühl / P2 Compatsch exigent désormais une réservation en ligne jusqu’à 6 jours à l’avance (30 €/jour au P2). On ne monte donc PAS en van : 25 min jusqu’à Siusi, on laisse le van en bas (le stationnement de nuit est toléré au pied de la cabinovia) et on monte en cabinovia (saison jusqu’au 1er novembre). En haut : boucles de l’Alpe di Siusi, le plus grand alpage d’Europe, face au Sciliar. Version costaud si les jambes suivent : Monte Pez – Rifugio Bolzano. Redescente en milieu d’après-midi, 10 min jusqu’au Camping Seiser Alm de Völs (ouvert jusqu’au 1er novembre) : spa, laverie, douches — le grand nettoyage de mi-parcours, et la seule vraie nuit confort du voyage. Réserver dans la journée. ⚠️ Même règle qu’en J8 : chien gratuit en cabinovia mais muselière + laisse obligatoires en cabine et en gare (☎ cabinovia Siusi 0471 704 270).' },
