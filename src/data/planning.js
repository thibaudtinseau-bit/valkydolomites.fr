...
// Déjà sans remontée : J6 Latemar, J7 Val San Nicolò, J10 Adolf Munkel, J12 Federa, J13 Tre Cime
...
export const DEFAULT_PLAN = [
  ...
  { date: '2026-09-21', title: 'Étape 5 — Repli au Passo Lavazè', base: 'fassa', spots: [], planB: null, drive: { km: 35, min: 55, label: 'Val d’Ega → Passo Lavazè' }, note: '❌ Journée blanche côté objectifs : ni Passo Sella, ni Marmolada. Nuit imprévue au Passo Lavazè (1 808 m, entre Val d’Ega et Val di Fiemme). Le Passo Sella est récupéré en J8 (à pied, par le Col Rodella). La Marmolada n’est plus qu’une vue depuis le barrage du Fedaia le soir du J7 : la benne du Sass Pordoi qui la surplombait a été écartée à cause du chien. Nuit froide en altitude : gaz plein.' },
