...
export const DEFAULT_PLAN = [
  ...
  { date: '2026-09-18', title: 'Étape 2 — Chamonix & Mont-Blanc', base: '', spots: [], planB: null, drive: { km: 95, min: 105, label: 'Aix-les-Bains → Chamonix (Annecy, vallée de l’Arve)' }, note: '~1h45 de route par Annecy et la vallée de l’Arve, avec un arrêt photo possible au belvédère du Plateau d’Assy (vue frontale sur tout le massif du Mont-Blanc). Après-midi tranquille à Chamonix : balade avec le chien au Lac des Gaillands (plat, 30 min, le Mont-Blanc s’y reflète par beau temps) ou montée en téléphérique au Plan de l’Aiguille (chiens acceptés muselés, panorama vertigineux sur toute la chaîne). Nuit : aire camping-car des Bossons ou de Chamonix, réveil face au glacier.' },
  { date: '2026-09-19', title: 'Étape 3 — Lac de Côme', base: '', spots: [], planB: null, drive: { km: 230, min: 195, label: 'Chamonix → Côme (tunnel du Mont-Blanc, Aoste)' }, note: 'Traversée du tunnel du Mont-Blanc (péage ~50-60 € aller en camping-car, réserver un créneau en ligne conseillé en saison) puis descente de la vallée d’Aoste et autoroute jusqu’au Lac de Côme (Ivrea → Novare → Côme). Fin d’après-midi et soirée au bord du lac : promenade avec le chien sur les rives de Côme ou d’Argegno, gelato obligatoire. Nuit : aire camping-car de Côme ou d’Argegno.' },
  ...
  { date: '2026-09-22', title: 'Entrée en Gardena', base: 'val-gardena', spots: ['vallunga'], planB: 'vallunga', drive: { km: 40, min: 65, label: 'Fedaia → Selva (Passo Sella)' }, note: 'Liaison vers Selva par le Passo Sella. Vallunga en après-midi tranquille — le paradis du chien. Nuit : aire de Selva ou Pontives.' },
  { date: '2026-09-23', title: 'Seceda, le graal', base: 'val-gardena', spots: ['seceda'], planB: 'vallunga', drive: { km: 8, min: 15, label: 'Selva → Ortisei' }, note: 'Téléphérique tôt depuis Ortisei, crêtes + descente Cisles–Col Raiser. LE jour à caler sur la meilleure météo de la fenêtre.' },
...
export const NIGHT_STOPS = [
  ...
  { days: 'J2', label: 'Chamonix · Mont-Blanc', coords: [45.9237, 6.8694], kind: 'road' },
  ...
  { days: 'J6-J7', label: 'Val Gardena (Selva / Pontives)', coords: [46.556, 11.758], kind: 'mtn' },
