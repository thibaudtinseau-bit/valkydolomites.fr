...
export const DEFAULT_PLAN = [
  ...
  { date: '2026-09-25', title: 'J9 — Passo Göma : les prés du Peitler, sans personne', base: 'alta-badia', spots: [], planB: null, drive: { km: 40, min: 60, label: 'Longiarù → Passo delle Erbe (30 min) → rando → retour' }, note: '🔄 Arbitré le 25/09 depuis Longiarù. L’Alpe di Siusi qui était prévue ici est ABANDONNÉE : depuis la Val Badia c’est 1h30 de retour en arrière, plus la montée obligatoire avant 9h et le parking P2 à réserver. L’Adolf Munkel est abandonné aussi : réservation du parking de Zannes COMPLÈTE jusqu’au 30 septembre, et feu de régulation à Ranui — rouge = demi-tour. LA RANDO — Passo delle Erbe → Passo Göma, 9,2 km, +434 m, 3h-3h30, aller-retour. Sentier 8A depuis le parking jusqu’à la Munt de Fornella, puis 8B vers l’Ütia de Göma, et une dernière courte montée au Passo Göma (2 109 m). Retour par le même chemin. On traverse les Peitlerwiesen, de grands prés d’altitude face à la paroi du Sass de Putia, avec le Plan de Corones et le Sas dla Crusc en vis-à-vis, et un refuge à mi-parcours. 🐶 LE POINT FORT : l’itinéraire CONTOURNE la Forcella de Putia. Pas de couloir de pierrier, pas de marches en bois, pas d’à-pic — rien à négocier avec le chien, contrairement au tour du Sass de Putia (13,4 km / +660 m) qui passe par là. ⛔ Ne PAS monter au sommet du Sass de Putia (2 875 m) : sentier attrezzato avec des passages sur rocher qu’un chien ne peut pas franchir. 🅿️ Parking du Passo delle Erbe (Jü de Börz, 1 987 m) : grand, payant, SANS feu ni réservation — aucun risque de se faire refouler, c’est tout l’intérêt par rapport à Funes. 🐑 Prés pâturés : laisse. ⏰ Rando courte, donc grosse marge — possibilité de basculer vers l’est dans l’après-midi pour prendre de l’avance sur la fin du voyage. 🗺️ AllTrails : https://www.alltrails.com/trail/italy/south-tyrol/passo-delle-erbe-passo-goma — Route : https://www.google.com/maps/dir/?api=1&origin=Longiar%C3%B9%2C+San+Martino+in+Badia&destination=Passo+delle+Erbe&travelmode=driving' },
