  ...
  return (
    <div className="page fade-in">
      ...
      <p className="notice">
        ...
        Péages notables : tunnel du Mont-Blanc (~50-60 € l’aller en camping-car — vérifier votre catégorie, réservation conseillée en saison), autoroutes italiennes, route des Tre Cime (~45 €).
      </p>
    </div>
  )
}
